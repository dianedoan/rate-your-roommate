...
function AboutContent() {
    return (
        <div className="about-content">
            ...
            <p className="content">
            <h5></h5>
                Whether you're moving to a new city, downsizing, or just looking for a better fit, <span className="highlight5">Rate Your Roommate</span> is here to make the process easier, faster, and better.
            </p>
            <h5></h5>
            <p className="content">
